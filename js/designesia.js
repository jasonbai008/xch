...
(function($) {
    ...
    console.log('%c眼里有光，脚下有路，心中有爱，兜里有钱','font-size:2em');
     ...
     jQuery(document).ready(function() {
        ...
        //  DOM解析完，就隐藏loading图层
         ...
         /* --------------------------------------------------
            * header | music
            * --------------------------------------------------*/
         player = new Audio('./music/hongzhijian.mp3');     
         ...
         $('.img-profile').on('click', function() {
            player.paused ? playMusic() : pauseMusic();
        })
		 
		 $(window).load(function() {
            filter_gallery();
            // hide preloader after loaded ，等待所有资源加载完太慢了
